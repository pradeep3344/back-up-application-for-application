      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="view.jsp">View Files</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="view2.jsp">View Images</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="view3.jsp">View Videos</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="ohome.jsp">Logout</a>
          </li>
        </ul>
      </div>
    </div>
...
String role="";
    try
    {
    	...
    	PreparedStatement ps=con.prepareStatement("select * from upload where role='Upload Videos'  and deletes!='1'");
    	ResultSet rs=ps.executeQuery();
    %>
     <center>      
   <br>
      <h2 style="color:crimson">View Upload Videos</h2>
  <br>
...
<!-- 						<th><font color="crimson">View File</font></th>
...
<%-- 			<td align="center"><a href="view.jsp?id=<%=rs.getString(6)%>"><font color="crimson">View File</font></a></td>
 --%>			<td align="center"><a href="down1.jsp?id=<%=rs.getString(6)%>">Download</font></a></td>
