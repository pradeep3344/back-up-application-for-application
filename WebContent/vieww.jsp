      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="vieww.jsp">View Files</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="vieww2.jsp">View Images</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="vieww3.jsp">View Videos</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
...
String role="";
    ...
    try
    {
    	...
    	PreparedStatement ps=con.prepareStatement("select * from upload where role='Upload Files'");
    	ResultSet rs=ps.executeQuery();
    %>
     <center>      
   <br>
      <h2 style="color:crimson">View Upload Files</h2>
  <br>
   		<table cellspacing="5" border="2" width="80%" padding: 28px;>
					<tr>
						...
						<th><font color="crimson">Delete</font></th>
			...
			<td align="center"><a href="view4.jsp?id=<%=rs.getString(6)%>"><font color="crimson">View File</font></a></td>
			<td align="center"><a href="delete1.jsp?id=<%=rs.getString(6)%>">Delete</font></a></td>
