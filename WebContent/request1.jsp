...
String role="";
    ...
    try
    {
    	...
    	PreparedStatement ps=con.prepareStatement("select * from upload where deletes='1' and delete1='1'");
    	ResultSet rs=ps.executeQuery();
    %>
     <center>      
   <br>
      <h2 style="color:crimson">View Request</h2>
  <br>
   		<table cellspacing="5" border="2" width="100%" padding: 28px;>
					<tr>
						...
						<th><font color="crimson">Request</font></th>
