...
%>
			 <h2>View  Files</h2>
							...
							<p><%=msg%></p>
							<%} %>
							<form name="form" action="mat2.jsp?id=<%=id %>" method="post" onsubmit="return validation()">
    <textarea    name="b" cols="30"  rows="5" ><%=t%></textarea>
<!--   <input type="submit" value="Download" class="sub1"> 
 -->      </form>
				<%
}
catch(Exception e)
