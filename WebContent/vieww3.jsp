...
<%-- 			<td align="center"><a href="view6.jsp?id=<%=rs.getString(6)%>"><font color="crimson">View File</font></a></td>
 --%>			<td align="center"><a href="delete3.jsp?id=<%=rs.getString(6)%>">Delete</font></a></td>
