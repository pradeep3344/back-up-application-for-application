...
String role="";
    ...
    %>
     <center>      
   <br>
      <h2 style="color:crimson">View Uploaded Files</h2>
  <br>
   		<table cellspacing="5" border="2" width="100%" padding: 28px;>
			...
			<td align="center"><a href="viewww.jsp?id=<%=rs.getString(6)%>"><font color="crimson">View File</font></a></td>
			<td align="center"><a href="down.jsp?id=<%=rs.getString(6)%>&&name=<%=rs.getString(2)%>">Download</font></a></td>
