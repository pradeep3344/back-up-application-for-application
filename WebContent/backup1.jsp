...
System.out.println(uname);
    try
    {
    	...
    	PreparedStatement ps=con.prepareStatement("select * from upload where deletes='1'");
    	ResultSet rs=ps.executeQuery();
    %>
     <center>      
   <br>
      <h2 style="color:crimson">View Deleted Files</h2>
  <br>
   		<table cellspacing="5" border="2" width="100%" padding: 28px;>
			...
			<td align="center"><a href="request.jsp?id=<%=rs.getString(6)%>&&uname=<%=uname%>"><font color="crimson">Request</font></a></td>
