      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="delete.jsp">View Files</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
...
String role="";
    ...
    try
    {
    	...
    	PreparedStatement ps=con.prepareStatement("select * from upload where role='Upload Images' and deletes!=1");
    	ResultSet rs=ps.executeQuery();
    %>
     <center>      
   <br>
      <h2 style="color:crimson">delete Uploaded Images</h2>
  <br>
   		<table cellspacing="5" border="2" width="100%" padding: 28px;>
			...
			<td align="center"><a href="view5.jsp?id=<%=rs.getString(6)%>&&name=<%=rs.getString(2)%>"><font color="crimson">View File</font></a></td>
			<td align="center"><a href="delete2.jsp?id=<%=rs.getString(6)%>">Delete</font></a></td>
