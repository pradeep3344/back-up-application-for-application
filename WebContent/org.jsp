    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="org.jsp">Organization</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="authority.jsp">Authority</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="login-form">
    <form action="backend.jsp" method="post">
        ...
        <h2 class="text-center">Organization Login</h2>   
    ...
    <p class="text-center small">Don't have an account? <a href="reg.jsp">Sign up here!</a></p>
</div>
</body>
